...
function movePlayer(now) {
  const movementSpeed =
    player.power === "Overdrive" ? 8 : player.speed;
  ...
  player.x = Math.max(
    0,
    Math.min(WORLD_WIDTH - player.width, player.x)
  );
